...
function updateCompare() {
  ...
  els.compareFormula.innerHTML = formatFormula(molecularFormula(state.compareSeries, carbons));
...
function syncNamingControls() {
  ...
  els.namingFormula.innerHTML = formatFormula(molecularFormula(series, carbons));
}
...
function setQuiz() {
  ...
  els.quizPrompt.innerHTML = `Name this ${series}: ${formatFormula(formula)}.`;
  els.quizInput.value = '';
...
function syncBuilderControls() {
  ...
  els.builderFormula.innerHTML = formatFormula(molecularFormula(series, carbons));
